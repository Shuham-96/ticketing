...
@section('page', trans('admin.index-title'))
            ...
            <div class="card bg-light">
                <div class="card-body row d-flex align-items-center">
                    ...
                    <div class="col-9 text-right">
                        <h1>{{ $tickets_count }}</h1>
                        <div>{{ trans('admin.index-total-tickets') }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="card bg-danger">
                <div class="card-body row d-flex align-items-center">
                    ...
                    <div class="col-9 text-right">
                        ...
                        <div>{{ trans('admin.index-open-tickets') }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="card bg-success">
                <div class="card-body row d-flex align-items-center">
                    ...
                    <div class="col-9 text-right">
                        ...
                        <span>{{ trans('admin.index-closed-tickets') }}</span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-deck mt-3">
                    <div class="card ">
                        <div class="card-header">
                            {{ trans('admin.index-tickets-share-per-category') }}
                        </div>
                        <div class="panel-body">
                    ...
                    <div class="card ">
                        <div class="card-header">
                            {{ trans('admin.index-tickets-share-per-agent') }}
                        </div>
                        <div class="panel-body">
                ...
                <div class="tab-content">
                    <div id="information-panel-categories" class="list-group tab-pane fade {{$active_tab == "cat" ? "show active" : ""}}">
                        <a href="#" class="list-group-item list-group-item-action disabled">
                            <span>{{ trans('admin.index-category') }}
                                <span class="badge badge-pill badge-secondary">{{ trans('admin.index-total') }}</span>
                            </span>
                            <small class="pull-right text-muted">
                                <em>
                                    {{ trans('admin.index-open') }} /
                                     {{ trans('admin.index-closed') }}
                                </em>
                            </small>
                        </a>
...
@section('footer')
    @if($tickets_count)
    {{--@include('bootstrap4.shared.footer')--}}
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            ...
            var options = {
                title: '{!! addslashes(trans('admin.index-performance-chart')) !!}',
                curveType: 'function',
            ...
            var cat_options = {
              title: '{!! addslashes(trans('admin.index-categories-chart')) !!}',
            ...
            var agent_options = {
              title: '{!! addslashes(trans('admin.index-agents-chart')) !!}',
              legend: {position: 'bottom'}
            };
