...
//    /**
    ...
    /**
     * Convert a DateTime to a Carbon object.
     *
     * @param  mixed  $value
    ...
    {
        // If the value is numeric, assume it's a Unix timestamp
        if (is_numeric($value)) {
            return Carbon::createFromTimestamp($value);
        } 
        // If the value matches the 'Y-m-d' format, create a Carbon instance and set the time to start of day
        elseif (preg_match('/^(\d{4})-(\d{2})-(\d{2})$/', $value)) {
            return Carbon::createFromFormat('Y-m-d', $value)->startOfDay();
        } 
        // If the value is not already a DateTimeInterface instance, use the default date format to create a Carbon instance
        ...
        // If the value is already a DateTimeInterface instance, convert it to Carbon
