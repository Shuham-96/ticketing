...
class Agent extends Model
{
    ...
    {
        if ($paginate) {
            return $query->where('ticket_admin', '1')->paginate($paginate, ['*'], 'admins_page');
        } else {
            return $query->where('ticket_admin', '1')->get();
        }
    }
    ...
    {
        return $this->belongsToMany('App\Models\Category', 'ticket_categories_users', 'user_id', 'category_id');
    }
