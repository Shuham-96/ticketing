...
class AdministratorsController extends Controller
{
    public function index()
    {
        ...
        return view('bootstrap4.admin.administrator.index', compact('administrators'));
    }
    ...
    public function create()
    {
        ...
        return view('bootstrap4.admin.administrator.create', compact('users'));
    }
    ...
    public function removeAdministrator($id)
    {
        ...
        $administrator->ticket_admin = false;
        $administrator->save();
