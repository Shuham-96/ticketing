...
class PrioritiesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('bootstrap4.admin.priority.index', compact('priorities'));
    }
    ...
    {
        return view('bootstrap4.admin.priority.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        Session::flash('status', trans('lang.priority-name-has-been-created', ['name' => $request->name]));
    ...
    public function edit($id)
    {
        ...
        return view('bootstrap4.admin.priority.edit', compact('priority'));
    }
    ...
    public function destroy($id)
    {
        ...
        Session::flash('status', trans('lang.priority-name-has-been-deleted', ['name' => $name]));
